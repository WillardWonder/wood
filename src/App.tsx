...
import { TrendingUp, AlertTriangle, ShieldAlert, FileText, RefreshCw } from 'lucide-react';
      ...
      <header className="max-w-7xl mx-auto mb-8 border-b border-red-900/50 pb-4 flex justify-between items-end">
        ...
        <div className="text-right hidden md:block">
          <div className="flex items-center justify-end gap-2 text-green-500 text-xs font-bold">
            <span className="animate-pulse">●</span> LIVE FEED ACTIVE
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {Object.entries(data?.spot_prices || {}).map(([species, price]) => (
              <div key={species} className="bg-slate-900 border border-slate-800 p-4 rounded-lg text-center hover:border-blue-500/50 transition-colors">
